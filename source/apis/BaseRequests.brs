        ...
        if type(event) = "roUrlEvent"
            ...
            if (isSuccess(code))
                ...
                if code < 0 then
                    ...
                    print "Failed for finalURL > " finalURL
                    req.asyncCancel()
                end if
    ...
    if (started)
        ...
        if type(event) = "roUrlEvent"
            ...
            if (isSuccess(code))
                ...
                if code < 0 then
                    print "*** BaseRequests : POST API Failed. Set cancel request *** "
    ...
    if (started)
        ...
        if type(event) = "roUrlEvent"
            ...
            if (isSuccess(code))
                ...
                if code < 0 then
                    print "*** BaseRequests : Delete API Failed. Set cancel request *** "
                    req.asyncCancel()
                end if
                failureResponse = fail(code, event.GetFailureReason())
                ' print "*** BaseRequests : Get API Failed. *** Response : " failureResponse
